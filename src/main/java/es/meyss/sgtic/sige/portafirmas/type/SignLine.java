...
public class SignLine  implements java.io.Serializable {
    private es.meyss.sgtic.sige.portafirmas.type.Signer[] signerList;

    private es.meyss.sgtic.sige.portafirmas.type.SignLineType type;

    public SignLine() {
    }

    public SignLine(
           es.meyss.sgtic.sige.portafirmas.type.Signer[] signerList,
           es.meyss.sgtic.sige.portafirmas.type.SignLineType type) {
     ...
     * @return signerList
     */
    public es.meyss.sgtic.sige.portafirmas.type.Signer[] getSignerList() {
        return signerList;
    }
     ...
     * @param signerList
     */
    public void setSignerList(es.meyss.sgtic.sige.portafirmas.type.Signer[] signerList) {
        this.signerList = signerList;
    }
     ...
     * @return type
     */
    public es.meyss.sgtic.sige.portafirmas.type.SignLineType getType() {
        return type;
    }
     ...
     * @param type
     */
    public void setType(es.meyss.sgtic.sige.portafirmas.type.SignLineType type) {
        this.type = type;
    }
